...
type BudgetServiceClient interface {
	CreateBudget(ctx context.Context, in *CreateBudgetRequest, opts ...grpc.CallOption) (*MessageResponsee, error)
	...
	UpdateBudget(ctx context.Context, in *UpdateBudgetRequest, opts ...grpc.CallOption) (*MessageResponsee, error)
	DeleteBudget(ctx context.Context, in *DeleteBudgetRequest, opts ...grpc.CallOption) (*BudgetDeleteResponse, error)
}
...
func (c *budgetServiceClient) CreateBudget(ctx context.Context, in *CreateBudgetRequest, opts ...grpc.CallOption) (*MessageResponsee, error) {
	out := new(MessageResponsee)
...
func (c *budgetServiceClient) GetBudgetById(ctx context.Context, in *GetBudgetByIdRequest, opts ...grpc.CallOption) (*BudgetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/budget.BudgetService/GetBudgetById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *budgetServiceClient) UpdateBudget(ctx context.Context, in *UpdateBudgetRequest, opts ...grpc.CallOption) (*MessageResponsee, error) {
	out := new(MessageResponsee)
...
func (c *budgetServiceClient) DeleteBudget(ctx context.Context, in *DeleteBudgetRequest, opts ...grpc.CallOption) (*BudgetDeleteResponse, error) {
	out := new(BudgetDeleteResponse)
...
type BudgetServiceServer interface {
	CreateBudget(context.Context, *CreateBudgetRequest) (*MessageResponsee, error)
	...
	UpdateBudget(context.Context, *UpdateBudgetRequest) (*MessageResponsee, error)
	DeleteBudget(context.Context, *DeleteBudgetRequest) (*BudgetDeleteResponse, error)
...
func (UnimplementedBudgetServiceServer) CreateBudget(context.Context, *CreateBudgetRequest) (*MessageResponsee, error) {
...
func (UnimplementedBudgetServiceServer) UpdateBudget(context.Context, *UpdateBudgetRequest) (*MessageResponsee, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateBudget not implemented")
}
func (UnimplementedBudgetServiceServer) DeleteBudget(context.Context, *DeleteBudgetRequest) (*BudgetDeleteResponse, error) {
...
func _BudgetService_GetBudgetById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/budget.BudgetService/GetBudgetById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var BudgetService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "budget_managment.proto",
}
